...
if ($('bpay')) $('bpay').onclick = () => runAgent(undefined);
if ($('bstale')) $('bstale').onclick = () => runAgent(1);

if ($('bact')) $('bact').onclick = async () => {
...
if ($('bresale')) $('bresale').onclick = async () => {
